...
public class ArpPacketAnalyzer {
     ...
     * @return
     */
    public static byte[] toBytes(ArpPacket obj) {
        byte[] data = new byte[28];
        data[0] = (byte) ((obj.hardwareType >> 8) & 0xFF);
        data[1] = (byte) (obj.hardwareType & 0xFF);
        data[2] = (byte) ((obj.protocolType >> 8) & 0xFF);
        data[3] = (byte) (obj.protocolType & 0xFF);
        data[4] = (byte) obj.hardwareAddressLength;
        data[5] = (byte) obj.protocolAddresslength;
        data[6] = (byte) ((obj.operation >> 8) & 0xFF);
        data[7] = (byte) (obj.operation & 0xFF);
        int current = 8;
    ...
    public static void main(String args[]) {
        ...
        byte[] bytes = ArpPacketAnalyzer.toBytes(p);
